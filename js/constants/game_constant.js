...
"Press Start Game Button on the right side to continue...";
     ...
     boosterdata[0] = {};
     boosterdata[0].name = "Bitconnect";
     boosterdata[0].desc = "Only 5 space exist, if you are outbuyed 15% interest is yours. Invest to Bitconnect now!";
     boosterdata[0].spec = "Global +100% Hashrate!";
     boosterdata[0].img =  "./images/bitconeeeee.png";
     ...
     boosterdata[2] = {};
     boosterdata[2].name = "BOOSTER 3";
     boosterdata[2].desc = "fasdfdsafds sdf dsa fsda fsdafds fds !";
